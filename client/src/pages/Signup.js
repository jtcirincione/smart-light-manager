            ...
            <div className="">
                ...
                <div className="flex justify-center">
                    <div className="ml-5 mt-16">
                        ...
                        <div className="flex justify-end items-center mt-4">Username: <input placeholder="username" required value={username} onChange={handleUsernameChange} onKeyUp={handleKeyPress} className="p-2 mt-4 ml-2 text-md font-bold border border-gray-900 rounded-lg drop-shadow-lg" /></div>
