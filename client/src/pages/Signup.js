        ...
        <div className="">
            ...
            <div className="flex justify-center">
                <div className="ml-5 mt-16">
                    ...
                    <div className="flex justify-end items-center mt-4">Usernamae: <input placeholder="username" value={username} onChange={handleUsernameChange} className="p-2 mt-4 ml-2 text-md font-bold border border-gray-900 rounded-lg drop-shadow-lg"/></div>
                    <div className="flex justify-end items-center mt-4">Email: <input placeholder="email" value={email} onChange={handleEmailChange} className="p-2 mt-4 ml-2 text-md font-bold border border-gray-900 rounded-lg drop-shadow-lg"/></div>
